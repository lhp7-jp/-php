...
<body>
    ...
    <form action="" method="post" class="text-center">
      <fieldset>
        ...
        <button onclick="window.location.href='page4.php';">Afficher les nouvelles valeurs</button>
